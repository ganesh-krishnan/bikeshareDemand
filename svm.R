...
svm.fit <- train (count ~ season + holiday + workingday + weather + temp + atemp +
...
y.pred <- predict (svm.fit, test.df)
...
write.csv (result.df, "result-svm.csv", quote=FALSE, row.names=FALSE)
